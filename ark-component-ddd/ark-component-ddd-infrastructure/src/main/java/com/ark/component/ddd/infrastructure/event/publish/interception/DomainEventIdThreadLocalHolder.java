package com.ark.component.ddd.infrastructure.event.publish.interception;
...
public class DomainEventIdThreadLocalHolder {
    ...
    public static void addEvents(List<DomainEvent> events) {
        events.forEach(DomainEventIdThreadLocalHolder::addEvent);
    }
