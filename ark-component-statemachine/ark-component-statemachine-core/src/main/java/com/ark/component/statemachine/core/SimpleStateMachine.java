...
public class SimpleStateMachine<S, E> implements StateMachine<S, E> {
    ...
    private final List<State<S>> states;
    ...
    public SimpleStateMachine(String machineId,
                              List<State<S>> states,
                              State<S> initial,
                              State<S> end,
                              List<Event<E>> events,
    ...
    @Override
    public Transition<S, E> findTransition(Event<E> currentEvent, String currentState) throws StateMachineException {
